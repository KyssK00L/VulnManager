...
> **[Version française disponible ici / French version available here](README.md)**
...
- `POST /api/types` - Create custom type (admin)
- `PUT /api/types/{type_name}` - Update type (admin)
- `DELETE /api/types/{type_name}` - Delete custom type (admin)
